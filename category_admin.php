                ...
                <div class="container-fluid">
                    ...
                    <div class="main-content" align="center">
                        ...
                        ?>
                                ...
                                if ($res->num_rows > 0) {
                                    ...
                                    foreach ($res as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="new_category.php?id=<?php echo $row["category_id"];?>">Edit</a></td>
                                            <td><a href="javascript:myFunction('delete_category.php?id=<?php echo $row["category_id"];?>')" onclick="myFunction('delete_category.php?id=<?php echo $row["category_id"];?>')">Delete</a></td>
                                        </tr>
                            ...
                            <h1><a href="new_category.php" style="text-decoration: none">Add New Category</a></h1>
                        <!-- Content Ends-->
                    </div>
                    <div class="row">
                        <div class="col-md-12">
