...
<?php
    ...
    if(mysqli_connect_error()){
        ...
        $sql="SELECT * FROM posts WHERE user_id='".$user_id."' AND is_active=1";
        if($user_type_id==1){
            $sqlAllPost="SELECT * FROM posts";
            $resAdmin=$con->query($sqlAllPost);
        }
            ...
            <h1>All Posts</h1>
                <table>
                    ...
                    <tr>
                        ...
                        <td><a href="javascript:myFunction('delete_post.php?id=<?php echo $row["post_id"];?>')" onclick="myFunction('delete_post.php?id=<?php echo $row["post_id"];?>')" >Delete</a></td>
                    </tr>
                    ...
                    <?php
                    if($user_type_id==1){
                        ?> <h1><br><br><br>Manage All Posts</h1>
                        <table>
                            ...
                            if ($resAdmin->num_rows > 0) {
                                ...
                                foreach ($resAdmin as $rowAdmin) {
                                    $sqlUserInfo = "SELECT * FROM users WHERE user_id='".$rowAdmin['user_id']."'";
                                    $resUserInfo = $con->query($sqlUserInfo);
                                    if($resUserInfo->num_rows > 0){
                                        $rowUserInfo=mysqli_fetch_array($resUserInfo);
                                    }
                                    $i++;
                                    ?>
                                    <tr>
                                        ...
                                        <td><?php echo $i;?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rowAdmin["title"];?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td><a href="admin_edit_post.php?id=<?php echo $rowAdmin["post_id"];?>">&nbsp;&nbsp;&nbsp;&nbsp;Edit</a></td>
                                        <td><a href="javascript:myFunctionDelete('admin_delete_forever.php?id=<?php echo $rowAdmin["post_id"];?>')" onclick="myFunctionDelete('admin_delete_forever.php?id=<?php echo $rowAdmin["post_id"];?>')" >&nbsp;&nbsp;&nbsp;&nbsp;Delete Forever</a></td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rowUserInfo['username'] ?></td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="post_active_change.php?id=<?php echo $rowAdmin['post_id']?>"><?php if($rowAdmin['is_active']==1){echo "change to inactive";} else{echo "change to active";} ?></a> </td>
                                    </tr>
                                    <script type="text/javascript">
                                        function myFunctionDelete(delurl) {
                                            console.log(delurl);
                                            var x=window.confirm("Are you sure to delete this post forever?")
                                            if (x)
                                                location.href=delurl;
                                            else
                                                location.reload(true);
