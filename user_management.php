            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div>
                            <br><h4>Pending Activation</h4><br>
                        </div>
                        <div class="row">
                        <!-- Content goes here -->
                            ...
                            <?php
                                ...
                                $userSQL = "SELECT users.user_id, users.username, users.username, users.email, users.user_type_id, users.is_active, persons.person_name, persons.gender, persons.date_of_birth, persons.imagepath FROM users INNER JOIN persons ON users.user_id=persons.user_id";
                                
                                $con = mysqli_connect("localhost", "root", "", "blog_cms");

                                $userList = $con->query($userSQL);
                            ?>
                            ...
                            <table>
                                ...
                                <?php
                                    ...
                                    foreach($userList as $usrRow)
                                    {
                                        if($usrRow['is_active'] == 0)
                                        {
                                            echo "<tr>";
                                            echo "<td>";
                                            echo $usrRow['user_id'];
                                            ...
                                            echo "<td>";
                                            echo $usrRow['date_of_birth'];
                                            echo "</td>";

                                            echo "<td>";
                                            if($usrRow['user_type_id'] == 1)
                                            {
                                                echo "Admin";
                                            }
                                            else
                                            ...
                                            if($usrRow['imagepath'] != "")
                                            {
                                                echo"<img src=\"".$usrRow['imagepath']."\" height=\"80\" width=\"80\">";
                                            }
                                            else
                                            {
                                                echo"<img src=\""."assets/images/icon/avatar-01.jpg"."\" height=\"80\" width=\"80\">";
                                            }
                                            echo "</td>";

                                            echo "<td>";
                                            echo "<a href=\"usr_mgt.php?activate=".$usrRow['user_id']."\">Activate</a><a href=\"usr_mgt.php?delete=".$usrRow['user_id']."\">Delete</a>";
                                            echo "</td>";
                                ...
                                <?php
                                    ...
                                    foreach($userList as $usrRow)
                                    {
                                        if($usrRow['is_active'] == 1)
                                        {
                                            ...
                                            echo "<td>";
                                            echo "<a href=\"usr_mgt.php?deactivate=".$usrRow['user_id']."\">Deactivate</a><a href=\"usr_mgt.php?delete=".$usrRow['user_id']."\">Delete</a>";
                                            if($usrRow['user_type_id'] == 1)
                                            {
                                                echo "<a href=\"usr_mgt.php?chng2usr=".$usrRow['user_id']."\">Change To User</a>";
                                            }
                                            else
                                            {
                                                echo "<a href=\"usr_mgt.php?chng2admin=".$usrRow['user_id']."\">Change To Admin</a>";
                                            }
