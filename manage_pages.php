...
<head>
    ...
    <!-- Title Page-->
    <title>All Pages | Dashboard</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <table>
                                ...
                                <?php
                                    $conPageList=mysqli_connect("localhost","root","","blog_cms");
                                    if(mysqli_connect_error()){
                                        echo "Failed to connect to mysql: ".mysqli_connect_error();
                                    }
                                    else{
                                        $sqlPageList = "SELECT * FROM pages WHERE is_active=1;";
                                        $resPageList = mysqli_query($conPageList, $sqlPageList);
                                if ($resPageList->num_rows > 0) {
                                ...
                                <tr>
                                    ...
                                    <td><p>&nbsp;&nbsp;&nbsp;&nbsp;</p></td>
                                    <td><a href="new_page.php?id=<?php echo $row["page_id"];?>">Edit</a></td>
                                    <td><p>&nbsp;&nbsp;&nbsp;&nbsp;</p></td>
                                    <td><a href="delete_page.php?id=<?php echo $row["page_id"];?>">Delete</a></td>
                                </tr>
                                <?php
                                }
                                }
